...
// -> Fuction jquery
    ...
    function closeModal() {
        $('.ui-widget-overlay, ui-front').click(function() {
            $(this).fadeOut(1000);
            $('#nkDialog').fadeOut(1000, function() {
...
*/
    ...
    function form(form) {
        ...
        formLogin.submit(function() {
            $.ajax({
                type: 'POST',
                url: formLogin.attr('action') + '&ajax=1',
                dataType: "json",
    ...
    function newMsgUserbox() {
        $('#jqueryNewMsg').click(function(event){
            ...
            $.ajax({
                ...
                url: getUrl + '&ajax=1',
                beforeSend:function() {
                    userboxContent.empty().append('<div id="bgOverlayUserbox"><div id="nkloader"></div></div>');
    ...
    function sendNewMsgUserbox() {
        ...
        form.find('.nkSubmit').click(function(event) {
            console.log('a');
            event.preventDefault();
            $.ajax({
                type: 'POST',
...
*/
    // -> Initialize load in js
        ...
        var cTotalFrames           = 25;
        var cFrameWidth            = 64;
        var cImageSrc              = 'assets/images/spritesLoadingUsers.png';
        ...
        function startAnimation(){
            document.getElementById('nkloader').style.backgroundImage='url('+cImageSrc+')';
            document.getElementById('nkloader').style.width=cWidth+'px';
            document.getElementById('nkloader').style.height=cHeight+'px';
        ...
        function continueAnimation(){
            ...
            if(document.getElementById('nkloader'))
                document.getElementById('nkloader').style.backgroundPosition=(-cXpos)+'px 0';
            cPreloaderTimeout=setTimeout('continueAnimation()', SECONDS_BETWEEN_FRAMES*1000);
        }
